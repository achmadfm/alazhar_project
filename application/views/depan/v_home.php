							...
							<div class="header-column">
								...
								<br><br>
									<a href="<?php echo base_url()?>">
										<img alt="Porto" width="295px" height="50px" src="<?php echo base_url()?>template/logo.png">
									</a>
								</div>
						...
						<div class="row counters">
								<div class="col-sm-6 col-lg-3">
									<div class="counter counter-warning appear-animation" data-appear-animation="bounceIn" data-appear-animation-delay="300">
										<i style="color:#e00000;" class="fa fa-user-o"></i>
										<strong style="color:#e00000;" data-to="<?php echo $visitoronline;?>">0</strong>
								...
								<div class="col-sm-6 col-lg-3">
									<div class="counter counter-warning appear-animation" data-appear-animation="bounceIn" data-appear-animation-delay="600">
										<i style="color:#e00000;" class="fa fa-users"></i>
										<strong style="color:#e00000;" data-to="<?php echo $pengunjung?>">0</strong>
								...
								<div class="col-sm-6 col-lg-3">
									<div class="counter counter-warning appear-animation" data-appear-animation="bounceIn" data-appear-animation-delay="900">
										<i style="color:#e00000;" class="fa fa-exchange"></i>
										<strong style="color:#e00000;" data-to="<?php echo $hits['total'];?>">0</strong>
								...
								<div class="col-sm-6 col-lg-3">
									<div class="counter counter-warning appear-animation" data-appear-animation="bounceIn" data-appear-animation-delay="1200">
										<i style="color:#e00000;" class="fa fa-line-chart"></i>
										<strong style="color:#e00000;" data-to="<?php echo $lastyear['visitor_last_year'];?>">0</strong>
