...
<html>
	<head>
		...
		<title>Informasi SMP | Bosowa Al-Azhar Cilegon</title>
			...
			<div role="main" class="main">
				...
				<section class="page-header">
					<div class="container">
						...
						<div class="row">
							<div class="col">
								<h1>SMP Bosowa Al-Azhar Cilegon</h1>
							</div>
						</div>
					</div>
				</section>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									...
									<h2 class="text-color-light mb-none">Pendaftaran Siswa Baru <br> Bosowa Al-Azhar Cilegon <br> <strong>Telah DiBuka</strong> </h2>
										<br>
