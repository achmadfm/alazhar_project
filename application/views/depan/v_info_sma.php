	...
	<body class="loading-overlay-showing" data-loading-overlay>
		...
		<div class="body">
							...
							<div class="header-column">
								...
								<br><br>
									<a href="<?php echo base_url()?>">
										<img alt="Porto" width="290px" height="50px" src="<?php echo base_url()?>template/logo.png">
									</a>
								</div>
								</div>
							</div>
			...
			<div role="main" class="main">
				...
				<section class="parallax section section-text-light section-parallax" data-plugin-parallax data-plugin-options="{'speed': 1}" data-image-src="<?php echo base_url()?>template/pendidikan/smabaru.png">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
